...
AI-native designer and engineer with 21 years of experience shipping product at the intersection of what's desirable, viable, and technically feasible. Uses AI as a force multiplier to design and build at a speed and scope that neither discipline achieves alone, from information architecture down to production React components. Trained in representational art, self-taught in engineering, built for this moment.
...
- Drove Industries' first two products from pre-GA to general availability, establishing design and front-end patterns that scaled across subsequent verticals
- Designed and engineered UI for 10 industry-specific products, from UX research through production React components
...
**Fine Tunes** | github.com/interfaceconjurer/fine-tunes
Python wrapper for training LoRA models on custom images, producing a Flux-based image generation model in minutes. Presented at github.com/interfaceconjurer/test-kitchen.

**Vibes-UI** | github.com/interfaceconjurer/vibes-ui
Shared React component library and Storybook for an agentic chat harness. Built the entire system using AI-assisted development to drive design consistency at engineering speed.
...
**Frameworks:** React, Storybook, Lightning Web Components
**Platforms:** Salesforce, Heroku, GitHub, Vercel
**Design:** Figma, FigJam, Design Systems, Prototyping, Information Architecture, UX Research
**Practices:** UX Engineering, Agile, CI/CD, Developer Tools, AI-Assisted Development
**AI & ML:** Claude Code, LoRA Model Training, Prompt Engineering, Concept-to-Code Workflows

---

## Education

**BFA in Illustration** | Laguna College of Art and Design, 2005
